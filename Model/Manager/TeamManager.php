...
class TeamManager extends DataManager
{
    ...
    public function getAllComputerTeams()
    {
        $records = $this->find('all', array(
            'fields' => array('id', 'money', 'name', 'formattion', 'player_count', 'league_id', 'bills', 'total_salary'),
    ...
    {
        $records = $this->find('all', array(
            'fields' => array('id', 'money', 'name', 'formattion', 'league_id', 'manager_id', 'player_count', 'bills', 'total_salary'),
